...
<img width="405" height="710" alt="image" src="https://github.com/user-attachments/assets/f019055f-b1d6-4d55-baec-8f2a8db0b263" /><img width="575" height="565" alt="image" src="https://github.com/user-attachments/assets/587df45c-3375-43cf-92bb-a0d1f2bee3ea" /> 
...
1. **Clone & install**
   ```
   git clone https://github.com/YOUR_USERNAME/finances_project.git
   cd finances_project
   ```
